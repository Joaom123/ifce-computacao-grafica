...
#
# b. paralelepípedo com lados iguais a 1.5 em x, 5.0 em y e 2.5 em z, com
# origem em um dos vértices pertencentes ao retângulo inferior e aresta
# paralela ao eixo y;
#
...
#
# d. tronco de pirâmide com bases quadradas de lados, respectivamente,
# iguais a 3.0 e 1.3, com altura de 2.5.
