# 1) Componha uma cena contendo os diversos sólidos modelados anteriormente
...
# possuir sólidos.
#
# b. O maior valor possível para cada uma das componentes de um vértice é
# 6. Se necessário aplique transformações de escala para que os sólidos
